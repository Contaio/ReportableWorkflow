...
@PublicComponent(name = "reportable_workflow_validate_recursive_release_element_executable", displayName = "ValidateRecursiveReleaseElementExecutable")
public class ValidateRecursiveReleaseElementExecutable extends AbstractExecutable {
