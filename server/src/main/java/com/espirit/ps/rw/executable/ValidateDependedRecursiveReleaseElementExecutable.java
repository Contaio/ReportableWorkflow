...
@PublicComponent(name = "reportable_workflow_validate_depended_recursive_release_element_executable", displayName = "ValidateDependedRecursiveReleaseElementExecutable")
public class ValidateDependedRecursiveReleaseElementExecutable extends AbstractExecutable {
