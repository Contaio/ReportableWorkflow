...
public class ValidationUtil {
	...
	public static ValidationContext createContext(final BaseContext context) {
		return new ValidationContext(context);
	}
	...
	public static List<ValidationState> validateData(final ValidationContext context, final Handle handle) {
