...
@PublicComponent(name = "reportable_workflow_validate_release_element_executable", displayName = "ValidateElementExecutable")
public class ValidateReleaseElementExecutable extends AbstractExecutable {
