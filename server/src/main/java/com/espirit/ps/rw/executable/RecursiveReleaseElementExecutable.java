...
@PublicComponent(name = "reportable_workflow_recursive_release_element_executable", displayName = "RecursiveReleaseElementExecutable")
public class RecursiveReleaseElementExecutable extends AbstractExecutable {
