...
@PublicComponent(name = "reportable_workflow_depended_release_element_executable", displayName = "DependedReleaseElementExecutable")
public class DependedReleaseElementExecutable extends AbstractExecutable {
