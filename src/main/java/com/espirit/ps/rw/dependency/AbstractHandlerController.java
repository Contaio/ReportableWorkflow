...
public abstract class AbstractHandlerController implements HandlerController {
	...
	private final List<Handler> allHandlers               = new UniqueHandlerList();
	private final List<Handler> currentlyIgnoreHandlers   = new UniqueHandlerList();
	private final List<Handler> permanentlyIgnoreHandlers = new UniqueHandlerList();
	private final List<Handler> loopList                  = new UniqueHandlerList();
	...
	@Override
	public final List<Handler> getLoadedHandlers() {
		return allHandlers;
	}
